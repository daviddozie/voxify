    ...
    <div className="py-[60px] bg-[#040411] px-[100px] relative">
      ...
      <div className="relative max-w-3xl mx-auto">
        <Swiper
          ...
          effect="coverflow"
          centeredSlides={true}
          slidesPerView={1.4} // Allows previous and next slides to be partially visible
          spaceBetween={-100}
          loop={true}
          navigation={{
          ...
          coverflowEffect={{
            rotate: 0,
            stretch: 50, // Adjusts how much slides stack behind
            depth: 150, // Creates a depth effect
            modifier: 1,
            slideShadows: false, // Disables side shadows
          }}
          breakpoints={{
